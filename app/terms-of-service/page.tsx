  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-12 space-y-6 text-sm leading-relaxed text-gray-700">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-gray-900">1. 服務說明</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-gray-900">2. 非醫療用途聲明</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-gray-900">3. 使用者責任</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-gray-900">4. 帳號與終止</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-gray-900">5. 免責聲明</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-gray-900">6. 條款修改</h2>
        <p>
      ...
      <section className="space-y-2">
        ...
        <p>
          若您對本服務條款有任何疑問，請透過
          <a href="https://www.threads.com/@wei1216iew" className="text-blue-600 underline">Threads</a>
          聯繫。
        </p>
      </section>
    </main>
