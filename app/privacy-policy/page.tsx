export default function PrivacyPolicyPage() {
  return (
    <main className="max-w-2xl mx-auto px-6  pt-12 pb-20 space-y-6 text-sm leading-relaxed text-text-body">
      <h1 className="text-2xl font-bold text-text-strong">隱私權政策</h1>
      <p className="text-text-subtle">最後更新日期：2026年7月5日</p>

      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-text-strong">1. 我們收集哪些資料</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-text-strong">2. 資料如何被使用</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-text-strong">3. 資料儲存與保護</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-text-strong">4. 資料存取範圍</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-text-strong">5. 第三方服務</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-text-strong">6. 您的權利</h2>
        <p>
