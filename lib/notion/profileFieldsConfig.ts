...
export const profileFields: ProfileFieldConfig[] = [
  ...
  { key: 'dietaryRestrictions', notionProp: '飲食禁忌/宗教限制', label: '飲食禁忌/宗教限制', type: 'multi_select', options: ['素食', '不吃牛', '無'], group: '過敏與疾病史' },
  { key: 'familyHistory', notionProp: '家族病史', label: '家族病史', type: 'rich_text', group: '過敏與疾病史', helperText: '自由文字填寫，例如：父親高血壓、母親糖尿病' },
  { key: 'currentConditions', notionProp: '目前診斷慢性病', label: '目前診斷慢性病', type: 'multi_select', options: ['無', '糖尿病前期', '高血壓', '胰島素阻抗', '其他'], group: '過敏與疾病史' },
